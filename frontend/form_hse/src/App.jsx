...
const getAuthHeaders = () => {
    const token = localStorage.getItem('authToken') || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY5MThjMWRmYjI0MDlkMjY4M2IzNTFhNCIsInJvbGUiOiJoc2UiLCJ1c2VybmFtZSI6InciLCJpYXQiOjE3NjMyMzAxNzUsImV4cCI6MTc2MzMxNjU3NX0.oG3oi_PmiNrF6W-2RJMFu1ON96c2O2MfD2T-dDEcszo'; 
    return {
        headers: {
